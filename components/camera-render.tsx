...
const CameraRender: React.FC = () => {
	...
	return (
		<div className="p-4 flex flex-col items-center justify-center">
			{!imageBlob ? (
				<>
					<div className="rounded-3xl overflow-hidden bg-black shadow-xl w-[418px] h-[313.5px]">
						<video
							ref={videoRef}
							autoPlay
							playsInline
				...
				<>
					...
					<div className="flex space-x-2 mt-4">
						...
						<button
							className="bg-neon-radial-gradient border border-1 text-black py-2 px-4 rounded-full border-black focus:outline-none focus:border-black hover:ring ring-black"
