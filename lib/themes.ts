...
export const themes: ThemesConfig = {
  ...
  minimal: {
    colors: {
      ...
      '--pf-token-badge-bg': 'var(--pf-primary-light)',
      '--pf-token-badge-color': 'var(--pf-muted)',
      '--pf-token-badge-border': 'none',
      '--pf-token-badge-radius': 'var(--pf-link-radius)',
      '--pf-shadow': 'none',
  ...
  modern: {
    colors: {
      ...
      '--pf-link-hover': 'var(--pf-primary)',
      '--pf-token-badge-bg': 'linear-gradient(45deg, var(--pf-primary), var(--pf-secondary))',
      '--pf-token-badge-color': 'var(--pf-text)',
      '--pf-token-badge-border': 'none',
      '--pf-token-badge-radius': 'var(--pf-link-radius)',
